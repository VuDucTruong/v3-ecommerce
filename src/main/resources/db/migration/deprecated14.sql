...
INSERT INTO public.products (id, created_at, deleted_at, group_id, image_url_id, name, original_price, price, prod_desc_id, quantity, represent, slug, tags) VALUES (8, '2025-04-17 16:49:31.057025', NULL, NULL, NULL, 'the jakarta product', 1000.00, 50.00, 3, 5, false, 'the-jakarta-product', '[]');
...
SELECT pg_catalog.setval('public.product_items_id_seq', 72, true);
...
SELECT pg_catalog.setval('public.product_items_used_id_seq', 8, true);
